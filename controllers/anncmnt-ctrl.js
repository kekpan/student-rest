...
exports.add_post = (req, res) => {
  ...
  req.getValidationResult().then((err) => {
    if (!err.isEmpty())
      return flashErrors.valid(req, res, err, "/anncmnts/add");
